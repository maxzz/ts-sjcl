 ...
 */
export class sha256 implements SjclHash {

    protected static _key: number[] = [];
    protected _h: BitArray = [];
    protected _buffer: BitArray = [];
